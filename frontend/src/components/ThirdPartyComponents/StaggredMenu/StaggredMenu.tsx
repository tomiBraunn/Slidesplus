  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {(() => {
            const raw = colors && colors.length ? colors.slice(0, 4) : ['white', 'white'];
            let arr = [...raw];
            if (arr.length >= 3) {
...
.sm-scope .sm-socials-title { margin: 0; font-size: 1rem; font-weight: 500; color: var(--sm-accent, white); }
...
.sm-scope .sm-socials-link:focus-visible { outline: 2px solid var(--sm-accent, white); outline-offset: 3px; }
.sm-scope .sm-socials-link { font-size: 1.2rem; font-weight: 500; color: #111; text-decoration: none; position: relative; padding: 2px 0; display: inline-block; transition: color 0.3s ease, opacity 0.3s ease; }
.sm-scope .sm-socials-link:hover { color: var(--sm-accent, white); }
...
.sm-scope .sm-panel-item:hover { color: var(--sm-accent, white); }
.sm-scope .sm-panel-list[data-numbering] { counter-reset: smItem; }
.sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { counter-increment: smItem; content: counter(smItem, decimal-leading-zero); position: absolute; top: 0.1em; right: 3.2em; font-size: 18px; font-weight: 400; color: var(--sm-accent, white); letter-spacing: 0; pointer-events: none; user-select: none; opacity: var(--sm-num-opacity, 0); }
